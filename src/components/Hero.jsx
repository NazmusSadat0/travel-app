  ...
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        />
        <h1 className="bold-52 lg:bold-88"> Hello World Camping</h1>
        <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]:">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum dolore
          debitis mollitia consectetur necessitatibus, iure consequatur officiis
          adipisci eveniet error recusandae velit itaque praesentium labore
          consequuntur? Iusto deserunt consequuntur molestiae?
        </p>
        ...
        <div className="relative z-20 w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
          <div className="flex flex-col">
            <div className="flex justify-between">
              <p className="text-sm text-gray-20">Location</p>
            ...
            <div className="flex justify-between">
              <div className="flex flex-col">
                ...
                <p className="bold-20 text-white">199.82 mi</p>
              </div>
              <div className="flex flex-col">
